...
from data_engine.datasets.navsim.loaders.navsim.agents.diffusiondrive.transfuser_model_v2 import V2TransfuserModel as TransfuserModel

from data_engine.datasets.navsim.loaders.navsim.agents.diffusiondrive.transfuser_callback import TransfuserCallback 
from data_engine.datasets.navsim.loaders.navsim.agents.diffusiondrive.transfuser_loss import transfuser_loss
from data_engine.datasets.navsim.loaders.navsim.agents.diffusiondrive.transfuser_features import TransfuserFeatureBuilder, TransfuserTargetBuilder
from data_engine.datasets.navsim.loaders.navsim.common.dataclasses import SensorConfig
from data_engine.datasets.navsim.loaders.navsim.planning.training.abstract_feature_target_builder import AbstractFeatureBuilder, AbstractTargetBuilder
from data_engine.datasets.navsim.loaders.navsim.agents.diffusiondrive.modules.scheduler import WarmupCosLR
from omegaconf import DictConfig, OmegaConf, open_dict
import torch.optim as optim
from data_engine.datasets.navsim.loaders.navsim.common.dataclasses import AgentInput, Trajectory, SensorConfig
...
class TransfuserAgent(AbstractAgent):
    ...
    def compute_trajectory_with_diversity(self, agent_input: AgentInput, diversity:int = 9)->Dict[str, Union[List[Trajectory], np.ndarray]]:
        """
        Compute multiple trajectories.
        :param current_input: Dataclass with agent inputs.
        :param diversity: Number of trajectories to generate.
        ...
        # forward pass
        with torch.no_grad():
            predic = self._transfuser_model.forward_with_diversity(features, diversity)
            poses = predic['trajectory']
            traj = [Trajectory(pose) for pose in poses]
            scores = predic['score']
            return {'trajectories': traj, 'scores': scores}
